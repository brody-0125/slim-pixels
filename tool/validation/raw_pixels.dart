// Research-only ABI adapter; excluded from the published package.
import 'dart:convert';
import 'dart:ffi';
import 'dart:io';
...
final class RawPixels {
  /// Loads an explicitly supplied library for archived comparisons.
  /// The loaded libraries remain resident for the lifetime of this isolate.
  RawPixels(String libraryPath) {
  ...
  /// Applies archived JSON fixtures through the diagnostic raw ABI.
  ///
